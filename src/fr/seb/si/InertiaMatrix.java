...
public class InertiaMatrix extends Matrix {
     ...
     */
    public static InertiaMatrix CreateDefault(Point G, Space R, Variable m) {
        InertiaMatrix im = new InertiaMatrix(G, R, m);

        Variable A = new Variable(String.format("A_{%s}", R.getId()), 1);
        Variable B = new Variable(String.format("B_{%s}", R.getId()), 1);
        Variable C = new Variable(String.format("C_{%s}", R.getId()), 1);
        Expression<Variable> negD = new Variable(String.format("D_{%s}", R.getId()), 1).invertSign();
        Expression<Variable> negE = new Variable(String.format("E_{%s}", R.getId()), 1).invertSign();
        Expression<Variable> negF = new Variable(String.format("F_{%s}", R.getId()), 1).invertSign();
     ...
     * @return the associate inertia matrix
     */
    public static InertiaMatrix CreateWithReflectionalSymmetry(Point G, Space R, Variable m, VECTOR Vp1, VECTOR Vp2) {
        InertiaMatrix im = CreateDefault(G, R, m);
     ...
     * @return the associate inertia matrix
     */
    public static InertiaMatrix CreateWithTwoReflectionalSymmetry(Point G, Space R, Variable m) {
        InertiaMatrix im = new InertiaMatrix(G, R, m);
     ...
     * @return the associate inertia matrix
     */
    public static InertiaMatrix CreateWithRotationalSymmetry(Point G, Space R, Variable m, VECTOR axis) {
        InertiaMatrix im = new InertiaMatrix(G, R, m);
     ...
     * @return the associate inertia matrix
     */
    public static InertiaMatrix CreateWithSphericalSymmetry(Point G, Space R, Variable m) {
        InertiaMatrix im = new InertiaMatrix(G, R, m);
